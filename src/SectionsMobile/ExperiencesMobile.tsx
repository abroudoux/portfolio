export default function ExperiencesMobile() {
  return (
    <section className="w-100 p-4 flex flex-col items-start my-5">
      <h2 className="text-md font-semibold underline mb-4 italic">experiences</h2>
      <ul className="flex flex-col gap-4">
        <li className="flex flex-col gap-2">
          <h3 className="text-xs underline font-semibold">
            Internship web developper - Coquille Consulting
          </h3>
          <span className="text-white/30 text-[10px] font-light">2023 - now</span>
          <p className="text-white/70 font-normal text-xs">
            ...
            I'm in charge of the creation of the different themes and the development of the
            back-end part of the websites. I also work on the company's internal tools.
          </p>
        </li>
        <li className="flex flex-col gap-2">
          <h3 className="text-xs underline font-semibold">
