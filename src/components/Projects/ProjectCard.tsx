...
const ProjectCard: FC<ProjectCardProps> = (props) => {
    ...
    return (
        <div className={`relative w-2/4 h-full rounded-lg hover:rounded-none border-2 border-grey-light overflow-hidden group transition-all`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
