...
export default function About() {
  const content = (
    <motion.div className="text-ms leading-8 text-muted-foreground" variants={itemsVariants}>
      <p className="mb-3">
        ...
        <HightlightString icon="👤" text="user experience" /> and the{" "}
        <HightlightString icon="🎨" text="design" /> of an application.
      </p>
      <p>
        In the continuity of my studies, I'm looking for an Internship from January 2024 near to{" "}
        <HightlightString icon="📍" text="Rennes" /> or{" "}
        <HightlightString icon="📍" text="Le Mans" />. I'm conviced that I can bring a lot to a new
